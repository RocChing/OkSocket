...
public class OkSocketOptions implements IIOCoreOptions {
    ...
    private IReader<IIOCoreOptions> reader;

    private IWriter<IIOCoreOptions> writer;
    ...
    public static class Builder {
        ...
        public Builder setReader(IReader<IIOCoreOptions> reader) {
            mOptions.reader = reader;
            return this;
        }

        public Builder setWriter(IWriter<IIOCoreOptions> writer) {
            mOptions.writer = writer;
            return this;
        }
    ...
    public static OkSocketOptions getDefault() {
        ...
        okOptions.reader = null;
        okOptions.writer = null;
        return okOptions;
    }

    public IReader<IIOCoreOptions> getReader() {
        return reader;
    }

    public IWriter<IIOCoreOptions> getWriter() {
        return writer;
    }
